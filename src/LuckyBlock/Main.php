...
class Main extends PluginBase implements Listener
{
    ...
    public function onEnable()
    {
        ...
        $this->message = new Config($dataResources . "message.yml", Config::YAML, [
                ...
                "explosion" => "BOOOM!!!",
                "drop" => "Chanceux",
                "sign" => "C'est ton problème!",
                "signText" => "C'est ton problème!",
                "prison" => "OPS...",
                "unlucky" => "Essayez encore peut-être vous serez plus chanceux",
                "spawn" => "Muahahahahha",
                "chest" => "Tu es très chanceux!",
                "effect" => "Ne vous inquiétez pas d'une chose",
                "not_allowed" => "Vous n'êtes pas autorisé à utiliser les LuckyBlock",
                "command" => "IDK",
                "mob" => "Surprise",
                "lightning" => "WTF"
            ]
