 ...
 * Copyright (C) 2018 georgianYT <https://github.com/georgianYT/>
 *
...
class Commands extends Command implements PluginIdentifiableCommand
{
    ...
    {
        parent::__construct("luckyblock", "LuckyBlock est un plugin qui vous permet de créer LuckyBlock!", "/lucky <command> <value>", ["luckyblock", "lucky", "lb"]);
    ...
    public function execute(CommandSender $sender, $label, array $args)
    {
        ...
        if (!$sender->hasPermission("luckyblock.command")) {
            $sender->sendMessage($this->tag . TextFormat::RED . "Vous n'êtes pas autorisé à utiliser cette commande!");
            return;
        }
        ...
        switch ($args[0]) {
            ...
            case "help":
                ...
                $message .= $this->tag . TextFormat::GRAY . "Developed by" . TextFormat::BOLD . " @georgianteam";
                ...
                switch ($args[1]) {
                    ...
                    case "add":
                        if (!isset($args[2]) || empty($args[2])) {
                            $sender->sendMessage($this->tag . TextFormat::RED . "paramètres invalides.");
                            return;
                        }
